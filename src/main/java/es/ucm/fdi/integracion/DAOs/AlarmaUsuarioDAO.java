...
/**
 * 
 * Operaciones con BD que requieren datos de usuarios y alarmas, 
 * tales como obtener la lista de alaramas de un usuario
 * 
 */

public interface AlarmaUsuarioDAO extends DAO<AlarmaUsuarioPOJO>{
	/**
	 * @param idUsuario usuario del que queremos obtener su lista de alarmas
