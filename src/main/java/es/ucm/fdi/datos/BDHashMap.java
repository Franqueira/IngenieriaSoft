...
/**
 * Esta clase representa una BD con una única tabla con clave primaria. Se puede
 * reescribir para almacenar en varias tablas. Se parametriza con un tipo
 * concreto. No se guarda en disco. Asume que cada objeto sobreescribe el método
 * toString
 * 
 * @author escalope, @jjgomezs
 *
 * @param <T>
 *            El parámetro que se quiere usar para la tabla. Se pueden poner
...
public class BDHashMap<T> {
	...
	/**
	 * Encontrar un objeto con un identificador concreto. Devuelve NULL si no se
	 * encuentra
	 * 
	 * @param id
	...
	/**
	 * Se borra un objeto de la tabla cuyo identificador coincida con el
	 * suministrado
	 * 
	 * @param id
	...
	/**
	 * Imprime la tabla por el flujo de salida indicado. Se puede dirigir a un
	 * fichero o a la salida estándar.
	 * 
	 * @param os
	 *            flujo donde volcar la salida
	 */
