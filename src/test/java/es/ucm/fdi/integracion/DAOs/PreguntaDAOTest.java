...
public class PreguntaDAOTest {
	...
	public void getAllTest() {
		...
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a2"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a3"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a4"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a5"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a6"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a7"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a8"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a9"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a10"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a11"));
		esperadas.add((PreguntaPOJO) preguntaDAO.getFromId("a12"));
