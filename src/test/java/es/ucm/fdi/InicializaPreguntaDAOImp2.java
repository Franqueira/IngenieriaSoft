 ...
 */
public class InicializaPreguntaDAOImp2 implements InicializaPreguntaDAO {
	...
	public void inicializa(PreguntaDAO preguntaDAO) {
		...
		preguntaDAO.save(new PreguntaPOJO("a5",
				"cual es la capital de España?", "geografía", respuestas1, 1));
		preguntaDAO.save(new PreguntaPOJO("a6",
		...
		preguntaDAO.save(new PreguntaPOJO("a8",
		...
		preguntaDAO.save(new PreguntaPOJO("a1", "cual es la capital de eeuu?",
				"geografía", respuestas2, 1));
		preguntaDAO.save(new PreguntaPOJO("a2", "cual es la capital de rusia?",
				"geografía", respuestas2, 2));
		preguntaDAO.save(new PreguntaPOJO("a3",
				"cual es la capital de checoslovaquia?", "geografía",
				respuestas2, 3));
		preguntaDAO
				.save(new PreguntaPOJO("a4", "cual es la capital de alemania?",
		...
		preguntaDAO.save(new PreguntaPOJO("a13",
				"cual es la capital de egipto?", "geografía", respuestas3, 1));
		preguntaDAO
				.save(new PreguntaPOJO("a14",
						"cual es la capital de dinamarca?", "geografía",
						respuestas3, 2));
		preguntaDAO.save(new PreguntaPOJO("a15",
		...
		preguntaDAO.save(new PreguntaPOJO("a9", "Quien descubrio America?",
				"historia", respuestas4, 1));
		preguntaDAO.save(new PreguntaPOJO("a10",
				"Quien planteo que la tierra giraba alrededor del sol?",
				"historia", respuestas4, 2));
		preguntaDAO.save(new PreguntaPOJO("a11", "Quien fue un rey visigodo?",
